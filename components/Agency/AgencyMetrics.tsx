...
const AgencyMetrics: React.FC = () => {
  const stats = [
    { label: 'Total Clients', value: '24', detail: '3 pending onboarding', color: 'text-blue-600', icon: 'ðŸ¢' },
    { label: 'Reseller Profit', value: '$4,280', detail: '32% margin', color: 'text-emerald-600', icon: 'ðŸ’°' },
    { label: 'Network Avg. Rating', value: '4.72', detail: 'Across 12k reviews', color: 'text-yellow-600', icon: 'â­' },
    { label: 'Active SMS Flows', value: '142', detail: '8.2k sent this month', color: 'text-purple-600', icon: 'ðŸ“±' },
  ];
