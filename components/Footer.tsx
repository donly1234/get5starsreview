        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-24">
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              {['f', 't', 'i', 'in', 'y'].map((s, i) => (
                <div key={i} className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-[#16A34A] transition-all cursor-pointer">
          ...
          <div>
            <h4 className="text-lg font-black mb-8 uppercase tracking-tight">Services</h4>
            <ul className="space-y-4 text-sm font-medium text-slate-400">
              <li><a href="#" className="hover:text-[#16A34A]">GBP Management Service</a></li>
              <li><a href="#" className="hover:text-[#16A34A]">Agency Partner Program</a></li>
              <li><a href="#" className="hover:text-[#16A34A]">Local Citation Building</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-lg font-black mb-8 uppercase tracking-tight">Helpful Links</h4>
            <ul className="space-y-4 text-sm font-medium text-slate-400">
              <li><a href="#" className="hover:text-[#16A34A]">Home</a></li>
              <li><a href="#" className="hover:text-[#16A34A]">Customer Success Stories</a></li>
              {/* Press Kit and Affiliate Program Removed */}
            </ul>
          </div>
        </div>

        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
           <div className="flex flex-wrap justify-center md:justify-start gap-8 text-[11px] font-bold uppercase tracking-widest">
             <span className="text-white">© Get5StarsReview</span>
             <a href="#" className="text-white hover:text-[#16A34A]">Terms of Use</a>
             <a href="#" className="text-white hover:text-[#16A34A]">Privacy Policy</a>
             {/* Accessibility Statement Removed */}
           </div>
