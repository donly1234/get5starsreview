    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm min-h-[300px] flex flex-col">
      ...
      {team.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-slate-50 rounded-2xl border-2 border-dashed border-slate-100 opacity-60">
           ...
           <p className="text-[9px] font-black uppercase tracking-widest text-slate-900">No Active Responders</p>
           <p className="text-[8px] font-medium text-slate-500 mt-1">Invite team members in settings to track engagement efficiency.</p>
        </div>
      ) : (
