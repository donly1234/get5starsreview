...
const templates = [
  { id: 't1', name: 'The Growth Pro', style: 'Modern & Bold', image: '📈', accent: '#16a34a' },
  { id: 't2', name: 'Corporate Trust', style: 'Professional & Clean', image: '🏢', accent: '#2563eb' },
  { id: 't3', name: 'Dark Mode SaaS', style: 'High-Tech & Sleek', image: '🌑', accent: '#9333ea' },
];
        ...
        <div className="w-full lg:w-80 space-y-6 shrink-0">
           ...
           <div className="bg-white p-6 rounded-[32px] border border-slate-200 shadow-sm space-y-8">
              ...
              <div className="space-y-4">
                 ...
                 >
                   {isGenerating ? 'AI Thinking...' : '✨ Rewrite with AI'}
                 </button>
              </div>
