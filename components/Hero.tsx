    ...
    <section className="relative pt-24 pb-16 md:pt-40 lg:pt-56 md:pb-52 overflow-hidden hero-gradient">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center space-y-8 md:space-y-12 lg:space-y-16">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[64px] font-[900] text-slate-950 leading-[1.1] md:leading-[1] lg:leading-[0.9] tracking-[-0.05em] uppercase italic animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
