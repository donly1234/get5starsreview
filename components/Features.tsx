      ...
      <div className="container mx-auto px-6 space-y-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          <div className="lg:w-1/2 space-y-6">
            ...
            <button className="px-8 py-3 bg-[#16A34A] text-white rounded-xl font-bold hover:bg-black transition-all shadow-lg shadow-green-500/20">LEARN MORE</button>
          </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-32">
          <div className="lg:w-1/2 space-y-6">
            ...
            <button className="px-8 py-3 bg-black text-white rounded-xl font-bold hover:bg-[#16A34A] transition-all shadow-lg">LEARN MORE</button>
          </div>
          <div className="lg:w-1/2">
        ...
        <div className="p-12 md:p-20 bg-green-50/60 rounded-[64px] border border-green-100 flex flex-col lg:flex-row items-center gap-16 lg:gap-32 shadow-sm">
          <div className="lg:w-1/2 space-y-6">
            ...
            <button className="px-8 py-3 bg-[#16A34A] text-white rounded-xl font-bold hover:bg-black transition-all shadow-lg">LEARN MORE</button>
          </div>
          <div className="lg:w-1/2">
