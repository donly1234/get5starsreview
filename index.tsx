...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Fail-safe: Force load after 4 seconds if session check hangs
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white">
        <div className="w-12 h-12 border-4 border-slate-100 border-t-[#16A34A] rounded-full animate-spin"></div>
